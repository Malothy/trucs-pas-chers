<?php
    ...
    $current = $same . " bg-gray-900 text-white bg-gray-900 text-white";
            ...
            <div class="flex items-center">
                ...
                <div class="hidden md:block">
                    <div class="ml-10 flex items-baseline space-x-4">
                        ...
                        <a href="index.php" class="<?php echo ($page === "index.php") ? $current : $default ; ?>"
                            aria-current="page">
                            Acceuil
                        </a>
                        ...
                        <a href="login.php" class="<?php echo ($page === "login.php") ? $current : $default ; ?>">
                            Login
                        </a>
                        <?php endif ;?>
                ...
                -->
                        <div class="absolute right-0 z-10 mt-2 w-48 origin-top-right rounded-md bg-white py-1 shadow-lg ring-1 ring-black/5 focus:outline-hidden"
                            ...
                            <form action="logout.php" method="POST">
                                <button href="#" class="block px-4 py-2 text-sm text-gray-700" role="menuitem" tabindex="-1"
                                    id="user-menu-item-2">
                                    Se deconnecter
                                </button>
                            </form> 
